 ...
 */
	...
	public class CustomRubikCube : MonoBehaviour
	{
    ...
    */
     ...
     */
		...
		public void Test(GameObject prefab, int x, int y, int z, Quaternion rotation)
		{
			Instantiate(prefab, _cublets[x, y, z]).transform.rotation = rotation;
		}
